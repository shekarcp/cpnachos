...
public class KThread {
    ...
    System.out.println("Before calling tcb.start()");
	tcb.start(new Runnable() {
		public void run() {
            System.out.println("calling runThread() function...");
		     runThread();
		}
	    });
	...
	public void run() {
        System.out.println("In target run function");
	    for (int i=0; i<2; i++) {
	...
	new KThread(new PingTest(1)).setName("cpar forked thread").fork();
	// new PingTest(0).run();
    }
